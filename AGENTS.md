...
- `doc/`: release, coverage, architecture, and integration notes.
...
- Public API changes: also update the relevant wiki page, [`wiki/14-high-level-api-index.md`](wiki/14-high-level-api-index.md), and [`doc/live_feature_coverage.md`](doc/live_feature_coverage.md).
...
6. Update `doc/live_feature_coverage.md` if the public feature matrix changed.
...
- work touching both library code and doc/tests/example
